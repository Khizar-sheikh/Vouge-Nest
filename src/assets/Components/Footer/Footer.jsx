...
const Gmaillink = "https://www.gmail.com";
const facebookLink = "https://www.facebook.com";
const instaLink = "https://www.instagram.com";
const githublink = "https://github.com/Khizar-sheikh"
...
function Footer() {
  return (
    <footer style={{rowGap: "1rem"}} className="footer  footer-center p-2 bg-base-300 text-base-content ">
      ...
      <p className="flex ">
        Copyright © {currentYear}- All right reserved by E-commerece-site Ltd
      </p>
      <p className="flex">
        Created by <a href={githublink}><strong>Khizar Sheikh</strong></a>
      </p>
    </footer>
  );
}
